...
import com.valizade.hellouniverse.screen.main.adapter.ImageAdapter;
import com.valizade.hellouniverse.utils.MAppCompatActivity;
import com.valizade.hellouniverse.Base;
import com.valizade.hellouniverse.entities.Image;
import com.valizade.hellouniverse.api.old.webservice.OnResponseListener;
...
public class MainActivity extends MAppCompatActivity implements ImageItemClickListener {
  ...
  public void getRandomImage() {
    com.valizade.hellouniverse.api.old.webservice.Call.getRandomImage(new OnResponseListener() {
      @Override
  ...
  public void getImagesList() {
    ...
    com.valizade.hellouniverse.api.old.webservice.Call.getImagesList(new OnResponseListener() {
      @Override
      public <T> void onResponse(T object) {
        super.onResponse(object);
